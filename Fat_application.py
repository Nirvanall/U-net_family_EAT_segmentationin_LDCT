"""
Created on Sun Mar 14 17:53:56 2021
...
parser.add_option("--data", dest="DATA_DIR", help="data set location", default="/home/liul/Fat_nii_down/", type="string")
parser.add_option("--batch_size", dest="batch_size", help="batch size", default=64, type="int") # 2048
...
model_path = "/home/liul1/upp_results/holdoutfat/run_"+str(model_path_idx)+"/"
...
class setup_config():
    ...
    def __init__(self, model="", 
                 ...
                 nb_class=None,
                 DATA_DIR = '/home/liul/Fat_nii_down/',
                ):
        self.model = model
...
x_train = np.load(os.path.join(config.DATA_DIR, "FAT_hold_image_down.npy"))
y_train = np.load(os.path.join(config.DATA_DIR, "FAT_hold_label_down_fatonly.npy"))
x_valid = np.load(os.path.join(config.DATA_DIR, "FAT_test_image_down.npy"))
y_valid = np.load(os.path.join(config.DATA_DIR, "FAT_test_label_down_fatonly.npy"))
...
'''
x_test = np.load(os.path.join(config.DATA_DIR, "FAT_test_image_down.npy"))
y_test = np.load(os.path.join(config.DATA_DIR, "FAT_test_label_down_fatonly.npy"))
